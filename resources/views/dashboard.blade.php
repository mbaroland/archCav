    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-red-400  ">
       <ul class="space-y-2 font-medium">
        ...
        <div x-data="{ openProjets: false }">
         <button @click="openProjets = !openProjets" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group w-full">
            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
               <path d="M3 1h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2zm0 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H3z"/>
               <path d="M2 4h14v2H2z"/>
               <path d="M2 8h14v2H2z"/>
               <path d="M2 12h9v2H2z"/>
           </svg>
         ...
         <div x-show="openProjets" @click.away="openProjets = false" class="pl-4">
             ...
             @can('projet-list')
                 <a href="{{ route('projet.index') }}" class="block p-2 text-gray-900 hover:text-gray-700 dark:text-white dark:hover:text-gray-300">Projets</a>
             @endcan
             @can('type_projet-list')
                 <a href="{{ route('categorie_projet.index') }}" class="block p-2 text-gray-900 hover:text-gray-700 dark:text-white dark:hover:text-gray-300">Axe stratégique</a>
             @endcan
         </div>
     </div>
          ...
          <div x-data="{ openArchives: false }">
            <button @click="openArchives = !openArchives" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group w-full">
               <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                  <path d="M3 2h12a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1zm0-1a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2H3z"/>
            ...
            <div x-show="openArchives" @click.away="openArchives = false" class="pl-4">
                ...
                @can('archive-list')
                    <a href="{{ route('archive.index') }}" class="block p-2 text-gray-900 hover:text-gray-700 dark:text-white dark:hover:text-gray-300">Archives</a>
                @endcan
                @can('type_archive-list')
                    <a href="{{ route('type_archive.index') }}" class="block p-2 text-gray-900 hover:text-gray-700 dark:text-white dark:hover:text-gray-300">Types archives</a>
                @endcan
            </div>
        </div>
          ...
          <div x-data="{ openRoles: false }">
            <button @click="openRoles = !openRoles" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group w-full">
            ...
            <div x-show="openRoles" class="pl-4">
                ...
                @can('user-list')
                    <a href="{{ route('users.index') }}" class="block p-2 text-gray-900 hover:text-gray-700 dark:text-white dark:hover:text-gray-300" @click="openRoles = false">Users</a>
                @endcan
                @can('role-create')
                    <a href="{{ route('roles.index') }}" class="block p-2 text-gray-900 hover:text-gray-700 dark:text-white dark:hover:text-gray-300" @click="openRoles = false">Roles</a>
                @endcan
            </div>
        </div>
