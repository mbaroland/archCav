<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 fixed left-0 right-0">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                {{-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('projet.index') }}" :active="request()->routeIs('projet.index')">
                        {{ __('Projet') }}
                    </x-nav-link>
                </div> --}}
            </div>
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                                        {{ Auth::user()->name }}
                                        <img src="{{ asset('bon.png') }}" class="h-8 mr-3" alt="ArchiCAV Logo" />
